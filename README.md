...
basato su stack e notazione inversa polacca. Ha una sintassi molto semplice e basilare.
## Come iniziare
### Prequisiti:
...
4. **Duplicare l'ultimo numero nello stack in base all'indice**: "numero DUP( indice )", esempio "1 5 3 DUP( 1 )"= stack=[1, 5, 3, 5]
